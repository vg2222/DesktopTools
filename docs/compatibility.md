...
DesktopTools 1.2.2 targets Windows 11 x64. The app is self-contained; screen recording additionally requires Microsoft Visual C++ x64 Redistributable and Windows Media Foundation.
