...
The language preference applies at the next app launch so changing it cannot discard utility drafts or interrupt active tools. Unknown values recover to English. Profile switching preserves the language setting. System dialogs and native Windows messages are controlled by the operating system.
